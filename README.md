...
- [`docs/guides/governed-agent-jobs.md`](docs/guides/governed-agent-jobs.md) — runbook for OAuth-bound agent admission, budgets, owned controls, installation, and rollback
